define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'lead/index/index' + location.search,
                    add_url: 'lead/index/add',
                    edit_url: 'lead/index/edit',
                    del_url: 'lead/index/del',
                    multi_url: 'lead/index/multi',
                    import_url: 'lead/index/import',
                    table: 'new_lead',
                }
            });
            ...
            table.on('post-common-search.bs.table', function (event, table) {
                ...
                $("input[name='lead_source']", form).addClass("selectpage").data("source", "lead/index/lead_source").data("primaryKey", "name").data("field", "name").data("orderBy", "id asc");
                $("input[name='admin_id']", form).addClass("selectpage")
                    .data("source", "auth/admin/index")
                    .data("primaryKey", "id")
                    .data("field", "username")
                    .data("params",function () {
                        return {custom: {switch: 1}};
                    })
                    .data("orderBy", "id asc");
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'id', title: __('Id'), operate: false},
                        {
                            field: 'status',
                            title: __('Status'),
                            searchList: {"0":__('New lead'),"1":__('Pre-screened'),"2":__('DQed'),"3":__('Tried contact and waiting')},
                ...
                onLoadSuccess:function(){
                    // 这里就是数据渲染结束后的回调函数
                    $(".btn-editone,.btn-add,data-operate-edit").data("area", ['80%','90%']);
                    $(".btn-editone,.btn-add,data-operate-edit").data("shade", [0.5,"#000"]);
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'lead/index/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
        ...
        notes: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'lead/index/notes/ids/'+$('#ids').val() + location.search,
                    del_url: 'lead/index/notes_del/form_id/'+$('#ids').val() + location.search,
                    table: 'notes',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'caozuo', title: __('Status'), searchList: {"0":__('New lead'),"1":__('Pre-screened'),"2":__('DQed'),"3":__('Tried contact and waiting')}, formatter: Table.api.formatter.status},
            ...
            $('.btn-save').click(function () {
                ...
                if (caozuo==3&&nexttime==''){
                    layer.msg('Next follow-up time cannot be empty');
                    return false;
                }
                $.ajax({
                    url:'lead/index/notes_add',
                    type:'get',
                    dataType:"json",
                    data:{form_id,email,content,caozuo,type,nexttime},
                    async:false,
