define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'donor/pre_screen/index' + location.search,
                    add_url: 'donor/pre_screen/add',
                    edit_url: 'donor/pre_screen/edit',
                    del_url: 'donor/pre_screen/del',
                    multi_url: 'donor/pre_screen/multi',
                    import_url: 'donor/pre_screen/import',
                    table: 'donor_pre_screen',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'donor/pre_screen/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
